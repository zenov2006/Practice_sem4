...
```
```md id="smzbsw"
- PostgreSQL — хранение истории поисковых запросов;
...
В backend-части реализовано сохранение истории поисковых запросов в PostgreSQL.

Для работы с историей используются endpoint-ы:

| Метод | Endpoint | Назначение |
|---|---|---|
| POST | `/api/search/history` | Сохраняет поисковый запрос в историю |
| GET | `/api/search/history` | Возвращает список последних поисковых запросов |
| DELETE | `/api/search/history` | Очищает историю поисковых запросов |
